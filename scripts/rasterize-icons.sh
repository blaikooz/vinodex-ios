...
if [ "${SKIP_ART:-0}" = "1" ]; then
  ...
  for importer in import-flavor-art.py import-grape-art.py import-style-art.py import-class-art.py import-stamp-art.py import-sticker-art.py import-logo-art.py import-button-art.py import-footer-art.py import-cartridge-art.py; do
