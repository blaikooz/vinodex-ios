...
ADMIN = {
    ...
    'gr-peripheries.json':   'Greece',
    'ge-regions.json':       'Georgia',
    'hr-counties.json':      'Croatia',
    'hu-counties.json':      'Hungary',
    'ro-counties.json':      'Romania',
    'bg-provinces.json':     'Bulgaria',
    'md-districts.json':     'Moldova',
    'ua-oblasts.json':       'Ukraine',
    'rs-districts.json':     'Republic of Serbia',
    'sk-regions.json':       'Slovakia',
    'si-municipalities.json': 'Slovenia',
    'il-districts.json':     'Israel',
    'lb-governorates.json':  'Lebanon',
    'cy-districts.json':     'Cyprus',
    'tr-provinces.json':     'Turkey',
    'am-provinces.json':     'Armenia',
    'ch-cantons.json':       'Switzerland',
    'uk-counties.json':      'United Kingdom',
    'jp-prefectures.json':   'Japan',
    'in-states.json':        'India',
    'ca-provinces.json':     'Canada',
    'mx-states.json':        'Mexico',
    'uy-departments.json':   'Uruguay',
    'ma-regions.json':       'Morocco',
    'au-states.json':        'Australia',
    'us-states.json':        'United States of America',
    'br-states.json':        'Brazil',
    'cz-regions.json':       'Czech Republic',
    'de-states.json':        'Germany',
    'za-provinces.json':     'South Africa',
}
